...
class Transaction():
    ...
    description : return the payment which is create  
    """
    ...
    author: Ranyl Foumbi
    params : userEmail
    description : return the list of payment according to the userEmail
    """
    ...
    author : Ranyl Foumbi
    params : userEmail
    description: return the list the number of request user can make to search niche and location
    """
    ...
    author : Ranyl Foumbi
    params : userEmail
    description : returns the list of search according to the user email
    """
